              ...
              PopupMenuButton<Map<String, String>>(
                ...
                itemBuilder: (context) {
                  ...
                  return [
                    ...
                    buildFav('Klipsch ProMedia 2.1 THX', '🔊 Klipsch ProMedia 2.1 THX', '#af-add=lavfi=[dynaudnorm=f=400:g=4.0:p=0.9,pan=stereo|FL=0.85*FL+0.5*FC+0.5*BL+0.5*LFE|FR=0.85*FR+0.5*FC+0.5*BR+0.5*LFE,anequalizer=c0 f=60 w=50 g=+4.5 t=1|c1 f=60 w=50 g=+4.5 t=1|c0 f=8000 w=2000 g=+2.5 t=1|c1 f=8000 w=2000 g=+2.5 t=1,acompressor=threshold=-18dB:ratio=3:makeup=2dB]'),
                    buildFav('Klipsch ProMedia 2.1 (Vocal / Speech)', '🗣️ Klipsch ProMedia 2.1 (Vocal / Speech)', '#af-add=lavfi=[dynaudnorm=f=300:g=4.0:p=0.85,pan=stereo|FL=0.55*FL+0.85*FC+0.15*BL+0.15*LFE|FR=0.55*FR+0.85*FC+0.15*BR+0.15*LFE,anequalizer=c0 f=80 w=60 g=-3.0 t=1|c1 f=80 w=60 g=-3.0 t=1|c0 f=300 w=150 g=-2.0 t=1|c1 f=300 w=150 g=-2.0 t=1|c0 f=1500 w=400 g=+2.0 t=1|c1 f=1500 w=400 g=+2.0 t=1|c0 f=2800 w=600 g=+4.0 t=1|c1 f=2800 w=600 g=+4.0 t=1|c0 f=4500 w=800 g=+2.5 t=1|c1 f=4500 w=800 g=+2.5 t=1|c0 f=8000 w=2000 g=-1.5 t=1|c1 f=8000 w=2000 g=-1.5 t=1,acompressor=threshold=-22dB:ratio=4.0:attack=3:release=90:makeup=4dB,alimiter=limit=-1dB]'),
                    ...
                    buildFav('KEF LS50 Wireless (Extreme Clarity)', '🔊 KEF LS50 Wireless (Extreme Clarity)', '#af-add=lavfi=[dynaudnorm=f=400:g=3.0:p=0.8,pan=stereo|FL=0.85*FL+0.4*FC+0.3*LFE|FR=0.85*FR+0.4*FC+0.3*LFE,anequalizer=c0 f=60 w=50 g=+2.0 t=1|c1 f=60 w=50 g=+2.0 t=1|c0 f=2000 w=500 g=+1.5 t=1|c1 f=2000 w=500 g=+1.5 t=1|c0 f=6000 w=1500 g=+2.5 t=1|c1 f=6000 w=1500 g=+2.5 t=1,acompressor=threshold=-18dB:ratio=1.5:makeup=1.5dB]'),
                    buildFav('Audioengine A5+ (Warm & Rich)', '🔊 Audioengine A5+ (Warm & Rich)', '#af-add=lavfi=[dynaudnorm=f=350:g=3.5:p=0.8,pan=stereo|FL=0.8*FL+0.5*FC+0.4*LFE|FR=0.8*FR+0.5*FC+0.4*LFE,anequalizer=c0 f=80 w=60 g=+3.5 t=1|c1 f=80 w=60 g=+3.5 t=1|c0 f=300 w=200 g=+1.5 t=1|c1 f=300 w=200 g=+1.5 t=1|c0 f=8000 w=2000 g=-1.0 t=1|c1 f=8000 w=2000 g=-1.0 t=1,acompressor=threshold=-20dB:ratio=2.0:makeup=2dB]'),
                    buildFav('Yamaha HS8 (Studio Flat)', '🔊 Yamaha HS8 (Studio Flat)', '#af-add=lavfi=[dynaudnorm=f=500:g=2.0:p=0.9,pan=stereo|FL=0.9*FL+0.3*FC+0.2*LFE|FR=0.9*FR+0.3*FC+0.2*LFE,anequalizer=c0 f=1000 w=500 g=+1.0 t=1|c1 f=1000 w=500 g=+1.0 t=1,acompressor=threshold=-14dB:ratio=1.2:makeup=0.5dB]'),
                    ...
                    buildFav('PreSonus Eris E3.5 (Tamed)', '🔊 PreSonus Eris E3.5 (Tamed)', '#af-add=lavfi=[dynaudnorm=f=400:g=3.0,pan=stereo|FL=0.85*FL+0.4*FC+0.3*LFE|FR=0.85*FR+0.4*FC+0.3*LFE,anequalizer=c0 f=100 w=80 g=-2.0 t=1|c1 f=100 w=80 g=-2.0 t=1|c0 f=8000 w=2000 g=+1.5 t=1|c1 f=8000 w=2000 g=+1.5 t=1,acompressor=threshold=-18dB:ratio=2.0:makeup=1.5dB]'),
                    buildFav('Edifier R1280T (Clarity Boost)', '🔊 Edifier R1280T (Clarity Boost)', '#af-add=lavfi=[dynaudnorm=f=350:g=3.5:p=0.8,pan=stereo|FL=0.8*FL+0.5*FC+0.3*LFE|FR=0.8*FR+0.5*FC+0.3*LFE,anequalizer=c0 f=200 w=150 g=-1.5 t=1|c1 f=200 w=150 g=-1.5 t=1|c0 f=4000 w=1000 g=+2.5 t=1|c1 f=4000 w=1000 g=+2.5 t=1|c0 f=8000 w=2000 g=+2.0 t=1|c1 f=8000 w=2000 g=+2.0 t=1,acompressor=threshold=-16dB:ratio=2.2:makeup=2dB]'),
                    buildFav('JBL 305P MkII (Fun V-Shape)', '🔊 JBL 305P MkII (Fun V-Shape)', '#af-add=lavfi=[dynaudnorm=f=400:g=2.5:p=0.9,pan=stereo|FL=0.9*FL+0.3*FC+0.4*LFE|FR=0.9*FR+0.3*FC+0.4*LFE,anequalizer=c0 f=50 w=40 g=+3.5 t=1|c1 f=50 w=40 g=+3.5 t=1|c0 f=1000 w=500 g=-1.0 t=1|c1 f=1000 w=500 g=-1.0 t=1|c0 f=8000 w=2000 g=+2.0 t=1|c1 f=8000 w=2000 g=+2.0 t=1,acompressor=threshold=-18dB:ratio=1.5:makeup=1dB]'),
                    const PopupMenuDivider(),
                    ...
                    buildFav('Beyerdynamic DT 990 Pro', '🎧 Beyerdynamic DT 990 Pro', '#af-add=lavfi=[dynaudnorm=f=300:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=70 w=50 g=+3.5 t=1|c1 f=70 w=50 g=+3.5 t=1|c0 f=8000 w=1500 g=+4.0 t=1|c1 f=8000 w=1500 g=+4.0 t=1,acompressor=threshold=-18dB:ratio=2.2:makeup=1dB]'),
                    buildFav('Audio-Technica ATH-M50x', '🎧 Audio-Technica ATH-M50x', '#af-add=lavfi=[dynaudnorm=f=350:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=+2.5 t=1|c1 f=60 w=50 g=+2.5 t=1|c0 f=8000 w=2000 g=-2.0 t=1|c1 f=8000 w=2000 g=-2.0 t=1,acompressor=threshold=-18dB:ratio=2.5:makeup=1dB]'),
                    buildFav('Bose QuietComfort Series', '🎧 Bose QuietComfort Series', '#af-add=lavfi=[dynaudnorm=f=400:g=3.0,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=-1.5 t=1|c1 f=60 w=50 g=-1.5 t=1|c0 f=2500 w=800 g=+2.5 t=1|c1 f=2500 w=800 g=+2.5 t=1,acompressor=threshold=-20dB:ratio=2.2:makeup=1.5dB]'),
                    buildFav('Samsung Galaxy Buds Pro', '🎧 Samsung Galaxy Buds Pro', '#af-add=lavfi=[dynaudnorm=f=300:g=3.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=100 w=80 g=-1.0 t=1|c1 f=100 w=80 g=-1.0 t=1|c0 f=4000 w=1000 g=+1.5 t=1|c1 f=4000 w=1000 g=+1.5 t=1,acompressor=threshold=-22dB:ratio=3:makeup=2dB]'),
                    buildFav('Apple AirPods', '🎧 Apple AirPods (Regular)', '#af-add=lavfi=[dynaudnorm=f=350:g=3.0,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=+4.5 t=1|c1 f=60 w=50 g=+4.5 t=1|c0 f=6000 w=1200 g=-1.5 t=1|c1 f=6000 w=1200 g=-1.5 t=1,acompressor=threshold=-20dB:ratio=2.5:makeup=1.5dB]'),
                    buildFav('Apple AirPods Max', '🎧 Apple AirPods Max', '#af-add=lavfi=[dynaudnorm=f=350:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=-2.0 t=1|c1 f=60 w=50 g=-2.0 t=1|c0 f=2500 w=600 g=+2.0 t=1|c1 f=2500 w=600 g=+2.0 t=1,acompressor=threshold=-18dB:ratio=2:makeup=1dB,alimiter=limit=-0.5dB]'),
                    buildFav('Beats Studio3', '🎧 Beats Studio3', '#af-add=lavfi=[dynaudnorm=f=300:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=-4.5 t=1|c1 f=60 w=50 g=-4.5 t=1|c0 f=2500 w=600 g=+3.0 t=1|c1 f=2500 w=600 g=+3.0 t=1|c0 f=8000 w=1500 g=+1.5 t=1|c1 f=8000 w=1500 g=+1.5 t=1,acompressor=threshold=-18dB:ratio=2.5:makeup=2dB]'),
                    buildFav('Anker Soundcore Life Q Series', '🎧 Anker Soundcore Life Q Series', '#af-add=lavfi=[dynaudnorm=f=350:g=3.0,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=70 w=50 g=-1.5 t=1|c1 f=70 w=50 g=-1.5 t=1|c0 f=2000 w=500 g=+2.5 t=1|c1 f=2000 w=500 g=+2.5 t=1|c0 f=7000 w=1500 g=+1.0 t=1|c1 f=7000 w=1500 g=+1.0 t=1,acompressor=threshold=-20dB:ratio=2.5:makeup=1.5dB]'),
                    buildFav('Audio-Technica ATH-M40x', '🎧 Audio-Technica ATH-M40x', '#af-add=lavfi=[dynaudnorm=f=350:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=+2.0 t=1|c1 f=60 w=50 g=+2.0 t=1|c0 f=8000 w=2000 g=+1.5 t=1|c1 f=8000 w=2000 g=+1.5 t=1,acompressor=threshold=-18dB:ratio=2.2:makeup=1dB]'),
                    const PopupMenuDivider(),
                    buildFav('SteelSeries Arctis 7 / Nova Pro', '🎮 SteelSeries Arctis 7 / Nova Pro', '#af-add=lavfi=[dynaudnorm=f=300:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=70 w=50 g=+2.0 t=1|c1 f=70 w=50 g=+2.0 t=1|c0 f=500 w=200 g=-1.5 t=1|c1 f=500 w=200 g=-1.5 t=1|c0 f=3000 w=600 g=+2.5 t=1|c1 f=3000 w=600 g=+2.5 t=1|c0 f=9000 w=1500 g=+2.0 t=1|c1 f=9000 w=1500 g=+2.0 t=1,acompressor=threshold=-20dB:ratio=2.5:makeup=1.5dB]'),
                    buildFav('Razer BlackShark V2', '🎮 Razer BlackShark V2', '#af-add=lavfi=[dynaudnorm=f=300:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=60 w=50 g=+2.5 t=1|c1 f=60 w=50 g=+2.5 t=1|c0 f=1000 w=300 g=+1.0 t=1|c1 f=1000 w=300 g=+1.0 t=1|c0 f=8000 w=1500 g=+2.5 t=1|c1 f=8000 w=1500 g=+2.5 t=1,acompressor=threshold=-20dB:ratio=2:makeup=1dB]'),
                    buildFav('HyperX Cloud II / Alpha', '🎮 HyperX Cloud II / Alpha', '#af-add=lavfi=[dynaudnorm=f=350:g=2.5,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=80 w=60 g=-2.5 t=1|c1 f=80 w=60 g=-2.5 t=1|c0 f=2500 w=500 g=+2.5 t=1|c1 f=2500 w=500 g=+2.5 t=1|c0 f=6000 w=1500 g=+1.5 t=1|c1 f=6000 w=1500 g=+1.5 t=1,acompressor=threshold=-18dB:ratio=2.5:makeup=1.5dB]'),
                    buildFav('Corsair Virtuoso / HS Series', '🎮 Corsair Virtuoso / HS Series', '#af-add=lavfi=[dynaudnorm=f=350:g=2.0,pan=stereo|FL=FL+0.5*FC|FR=FR+0.5*FC,anequalizer=c0 f=70 w=50 g=+1.5 t=1|c1 f=70 w=50 g=+1.5 t=1|c0 f=3000 w=600 g=+1.5 t=1|c1 f=3000 w=600 g=+1.5 t=1|c0 f=9000 w=1500 g=+1.0 t=1|c1 f=9000 w=1500 g=+1.0 t=1,acompressor=threshold=-18dB:ratio=2:makeup=1dB]'),
                    const PopupMenuDivider(),
                    buildFav('Sonos Beam / Arc (Soundbar)', '📺 Sonos Beam / Arc (Soundbar)', '#af-add=lavfi=[dynaudnorm=f=400:g=3.0:p=0.7,pan=stereo|FL=0.85*FL+0.5*FC+0.3*LFE|FR=0.85*FR+0.5*FC+0.3*LFE,anequalizer=c0 f=2000 w=500 g=+1.5 t=1|c1 f=2000 w=500 g=+1.5 t=1,acompressor=threshold=-20dB:ratio=2.5:makeup=1.5dB,alimiter=limit=-1dB]'),
                    buildFav('Samsung / LG Soundbar (Bundled)', '📺 Samsung / LG Soundbar (Bundled)', '#af-add=lavfi=[dynaudnorm=f=400:g=3.0:p=0.8,pan=stereo|FL=0.8*FL+0.5*FC+0.2*LFE|FR=0.8*FR+0.5*FC+0.2*LFE,anequalizer=c0 f=80 w=60 g=-3.0 t=1|c1 f=80 w=60 g=-3.0 t=1|c0 f=2500 w=600 g=+3.0 t=1|c1 f=2500 w=600 g=+3.0 t=1,acompressor=threshold=-20dB:ratio=2.5:makeup=2dB,alimiter=limit=-1dB]'),
                    buildFav('TV Built-in Speakers (Generic)', '📺 TV Built-in Speakers (Generic)', '#af-add=lavfi=[dynaudnorm=f=200:g=5.0:p=0.85:m=6,pan=stereo|FL=0.6*FL+0.7*FC+0.2*LFE|FR=0.6*FR+0.7*FC+0.2*LFE,anequalizer=c0 f=40 w=30 g=-4.0 t=1|c1 f=40 w=30 g=-4.0 t=1|c0 f=150 w=80 g=+3.0 t=1|c1 f=150 w=80 g=+3.0 t=1|c0 f=2500 w=600 g=+3.5 t=1|c1 f=2500 w=600 g=+3.5 t=1|c0 f=6000 w=1500 g=-1.5 t=1|c1 f=6000 w=1500 g=-1.5 t=1,acompressor=threshold=-26dB:ratio=5:attack=3:release=60:makeup=5dB,alimiter=limit=-1.5dB]'),
                    buildFav('Laptop / Monitor Speakers (Generic)', '📺 Laptop / Monitor Speakers (Generic)', '#af-add=lavfi=[dynaudnorm=f=150:g=6.0:p=0.9:m=7,pan=stereo|FL=0.5*FL+0.8*FC+0.15*LFE|FR=0.5*FR+0.8*FC+0.15*LFE,anequalizer=c0 f=40 w=30 g=-6.0 t=1|c1 f=40 w=30 g=-6.0 t=1|c0 f=200 w=100 g=+3.5 t=1|c1 f=200 w=100 g=+3.5 t=1|c0 f=3000 w=700 g=+4.0 t=1|c1 f=3000 w=700 g=+4.0 t=1|c0 f=7000 w=1500 g=-2.0 t=1|c1 f=7000 w=1500 g=-2.0 t=1,acompressor=threshold=-28dB:ratio=6:attack=2:release=50:makeup=6dB,alimiter=limit=-1.5dB]'),
                    const PopupMenuDivider(),
